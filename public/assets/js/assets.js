    ...
    $('#addAssetForm').submit(function(event) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                var errorMessage = xhr.responseJSON && xhr.responseJSON.message ? xhr.responseJSON.message : 'An error occurred while adding the assets details. Please try again.';
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: errorMessage,
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response && response.message) {
                    ...
                    Swal.fire({
                        title: "Edit Asset Updated Successfully",
                        toast: true,
                        icon: "success",
                        timer: 3000,
                        position: "top-right",
            ...
            error: function(xhr, status, error) {
                // If update fails, display error message (you can customize this)
                var errorMessage = xhr.responseJSON && xhr.responseJSON.message ? xhr.responseJSON.message : 'An error occurred while updating the assets details. Please try again.';
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: errorMessage,
