$(document).ready(function() {
    ...
    $('#addNextOfKinForm').submit(function(event) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                var errorMessage = xhr.responseJSON && xhr.responseJSON.message ? xhr.responseJSON.message : 'An error occurred while adding the next of kin. Please try again.';
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: errorMessage,
    ...
    // Event listener for Add Product form submission
    $('#editNextOfKinForm').submit(function(event) {
        event.preventDefault(); // Prevent default form submission
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                // If update fails, display error message (you can customize this)
                var errorMessage = xhr.responseJSON && xhr.responseJSON.message ? xhr.responseJSON.message : 'An error occurred while updating the next of kin. Please try again.';
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: errorMessage,
