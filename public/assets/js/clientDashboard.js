...
// chart 3
 ...
 var ctx = document.getElementById('client-chart3').getContext('2d');
  ...
  var gradientStroke1 = ctx.createLinearGradient(0, 0, 0, 300);
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
                label: 'Facebook',
                data: [5, 30, 16, 23, 8, 14, 2,6,7,40,7,1],
                backgroundColor: [
                  gradientStroke1
                ],
				fill: {
...
var ctx = document.getElementById("client-chart4").getContext('2d');
  ...
  // chart 5
    ...
    var ctx = document.getElementById("client-chart5").getContext('2d');
