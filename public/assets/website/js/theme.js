...
function swithcerMenu() {
    if ($('.switch_menu').length) {
        ...
        $('#styleOptions .color1').on('click', function() {
            $('.main_menu .logo img').attr('src', 'images/logo/KAMULLL02_header.png');
            $('footer .footer_logo img').attr('src', 'images/logo/KAMULLL02_footer1.png');
            ...
            Cookies.set('logo-img', 'images/logo/KAMULLL02_header.png', { expires: 365, path: '/' });
            Cookies.set('logo-img-footer','images/logo/KAMULLL02_footer1.png', { expires: 365, path: '/' });
