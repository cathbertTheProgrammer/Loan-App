<x-website-layout>
				...
				<div id="main_slider" class="rev_slider"  data-version="5.0">
					<ul>
						...
						<li data-index='rs-355' class="slide_show slide_1" data-transition='boxslide' data-slotamount='default' data-easein='default' data-easeout='default' data-masterspeed='default' data-rotate='0' data-saveperformance='off' data-title='Slide Boxes' data-description=''> <!-- Slide_show -->
							<img src="{{asset('assets/website/images/home/slide-4.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" >
						...
						<li data-index='rs-356' class="slide_show slide_2" data-transition='slotslide-vertical' data-slotamount='default' data-easein='default' data-easeout='default' data-masterspeed='default' data-rotate='0' data-saveperformance='off' data-title='Slide Slots vertical' data-description=''> <!-- Slide2 -->
							...
							<img src="{{asset('assets/website/images/home/slide-2.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
						...
						<li class="slide_show slide_3" data-index='rs-381' data-transition='3dcurtain-vertical' data-slotamount='default' data-easein='default' data-easeout='default' data-masterspeed='default' data-rotate='0' data-saveperformance='off' data-title='3D Curtain Vertical' data-description=''> <!-- Slide_3 -->
							...
							<img src="{{asset('assets/website/images/home/slide-1.jpg')}}"alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 single_excellance">
						...
						<div class="text">
							...
							<p class="tran3s">The Kamulll Group of Companies prides itself on delivering top-notch services that help clients achieve their goals with ease and confidence. Whether it's navigating complex financial landscapes, securing immigration status, clearing customs efficiently, or Cash Advance and Loan services, Kamulll is a trusted partner in your success.</p>
						</div> <!-- End of .text -->
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 about_Kamulll group of Companies">
						...
						<p>The Kamulll Group of Companies is a multifaceted service provider offering a range of professional services across various sectors. Our comprehensive suite of offerings caters to both individual and corporate clients, ensuring expert guidance and efficient solutions <br> <br>
						We strive to build a relationship of trust with every client, for the long-term.70% of our work is for clients that we have served for over 3 years.</p>
						...
						<div class="slider_wrapper">
							<div class="testimonial-carousel-content-box owl-carousel owl-theme">
								...
								<div class="item">
									...
									<div class="author">
										<img src="{{asset('assets/website/images/home/placeholderFaces.jpg')}}" alt="Client Image" class="float_left border_round">
								...
								<div class="item">
									<div class="text p_color_bg">
										<i>Kamulll group of Companies providing you the best consultancy for your business We serve clients at every level of their organization</i>
									</div> <!-- End of .text -->
									<div class="author">
										<img src="{{asset('assets/website/images/home/placeholderFaces.jpg')}}"  alt="Client Image" class="float_left border_round">
										<div class="author_name float_left">
								...
								<div class="item">
									...
									<div class="author">
										<img src="{{asset('assets/website/images/home/4.jpg')}}"  alt="Client Image" class="float_left border_round">
										<div class="author_name float_left">
											<h6 class="p_color">Aaron Mwelwa <span></span></h6>
											<ul>
												<li><i class="fa fa-star" aria-hidden="true"></i></li>
							...
							<div class="thumbnail_wrapper">
								<div class="testimonial-carousel-thumbnail-box owl-carousel owl-theme">
									<div class="item">
										<img  src="{{asset('assets/website/images/home/placeholderFaces.jpg')}}" alt="Image"/>
									</div>
									<div class="item">
										<img src="{{asset('assets/website/images/home/placeholderFaces.jpg')}}"  alt="Image"/>
									</div>
		...
		<div class="award_banner">
			<div class="overlay">
				<div class="container">
					...
					<p>The Consumers' Choice Award was established to identify and promote business excellence. The award utilizes a unique survey that asks consumers to choose the best in their city. Leading independent research organizations</p>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 callBack_text">
						...
						<p><span>For Business: </span> For Business inquiry fill our short feedback form or you can also send us an <a href="#" class="s_color" title="E-mail us">email</a> and we’ll get in touch shortly, or Troll Free Number <a href="#" class="p_color" title="Call us">(260) 765675740, (260) 957713086</a></p>

						<p><span>For Customer Support :</span> If you have any doubt about Kamulll group of Companies WordPress or how we can support your business, Send us an <a href="#" class="s_color" title="E-mail us">email</a> and we’ll get in touch shortly, or Contact via <a href="#" class="s_color" title="Contact via Support Forum">Support Forum</a></p>
		...
		<section id="google-map-area">
			...
			<div style="max-width:100%;list-style:none; transition: none;overflow:hidden;width:1900px;height:474px;"><div id="display-google-map" style="height:100%; width:100%;max-width:100%;"><iframe style="height:100%;width:100%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=PLOT+1,+KALABO+COURT+,+RHODESPARK,+LUSAKA,+ZAMBIA&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe></div><a class="from-embedmap-code" href="https://www.bootstrapskins.com/themes" id="make-map-data">premium bootstrap themes</a><style>#display-google-map img{max-width:none!important;background:none!important;font-size: inherit;font-weight:inherit;}</style></div>
				...
				<div class="container">
					<div class="map_address">
						<div class="item">
							...
							<ul>
								<li><i class="fa fa-map-marker s_color" aria-hidden="true"></i>PLOT 1, KALABO COURT , RHODESPARK, LUSAKA, ZAMBIA</li>
								<li><i class="fa fa-phone s_color" aria-hidden="true"></i><a href="tel:(260) 765675740">(260) 765675740, (260) 957713086</a></li>
								<li><i class="fa fa-envelope s_color" aria-hidden="true"></i><a href="#">info@kamulllgroup.co.zm</a></li>
							</ul>
						</div> <!-- End of .item -->
