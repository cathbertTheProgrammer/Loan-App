                                ...
                                <div class="border border-3 p-4 rounded">
                                    <div class="row">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="col-2">
                                                <div class="d-grid">
                                                    <button type="submit"  class="btn btn-success" id="recommendationBtn">Recommend</button>
                                                </div>
                                            </div>

                                            <div class="col-2">
                                                <div class="d-grid">
                                                    <button type="submit"  class="btn btn-danger" id="rejectRecommendationBtn">Reject</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
