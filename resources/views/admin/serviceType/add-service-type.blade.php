    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
				...
				<form id="addServiceTypeForm" method="POST" enctype="multipart/form-data" action="{{ route('serviceTypes.store') }}">
					@csrf
					@method('POST')
							...
							<div class="">
								<div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="service_type" id="service_type"   placeholder="Enter service type" required>
                                    </div>
                                    ...
                                    <div class="">
                                        <button type="submit"  class="btn btn-primary" id="addServiceType">Submit</button>
                                    </div>
