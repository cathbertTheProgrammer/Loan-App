        ...
        <div class="card">
            <div class="card-body p-4">
                <div class="col-lg-6 col-xl-6">
                    <a href="{{ route('serviceTypes.add') }}" class="btn btn-primary btn-sm mb-3 mb-lg-0"><i class='bx bxs-plus-square'></i>Add Service Type</a>
                </div>
                <hr />
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-2">
                                                <h6 class="mb-0 font-14">{{ $service->service_type }}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="{{ route('serviceTypes.edit', ['serviceType' => $service->id]) }}">
