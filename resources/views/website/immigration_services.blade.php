					...
					<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right service_page_main_post ">
						<div class="wrapper">
							...
							<div class="main_img_holder">
								<img src="{{asset('assets/website/images/service/11.jpg')}}" alt="image" class="img-responsive">
								<h4 class="p_color_bg s_color">Immigration Services</h4>
								...
								<div class="row">
									<div class="col-lg-5 col-md-12 col-sm-6 col-xs-12">
										<div class="theme_title pFix">
											<h4>Business plan services</h4>
										</div>
										<ul>
											<li>Marketing Plan</li>
											<li>Product(s)/service(s) </li>
											<li>Market overview and Competition.</li>
											<li>Customer demographics</li>
											<li>Competitive advantage</li>
											<li>Advertising and promotional strategy</li>
											<li>Production arrangements</li>
											<li>Organization structure</li>
											<li>Costs and sources of funds</li>
							...
							<div class="profit-improvement clear_fix">
								<div class="text float_left">
									<div class="theme_title pFix">
