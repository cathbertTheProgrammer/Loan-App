    ...
    <div class="page-breadcrumb p_color_bg">
        <div class="container clear_fix">
            <ul class="text-center">
                ...
                <li>Contact</li>
                <li><a href="contact.html">Apply for Loan</a></li>
            </ul>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 callBack_text">
                    ...
                    <p><span>For Business: </span> For Business inquiry fill our short feedback form or you can also
                        send us an <a href="#" class="s_color" title="E-mail us">email</a> and we’ll get in touch
                        shortly, or Troll Free Number <a href="#" class="p_color" title="Call us">(260) 765675740,
                            (260) 957713086</a></p>
                    ...
                    <p><span>For Customer Support :</span> If you have any doubt about Kamulll group of Companies
                        WordPress or how we can support your business, Send us an <a href="#" class="s_color"
                            title="E-mail us">email</a> and we’ll get in touch shortly, or Contact via <a href="#"
                            class="s_color" title="Contact via Support Forum">Support Forum</a></p>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 req_callBackForm">
                    <form action="https://st.ourhtmldemo.com/template/consult-press/inc/sendemail.php"
                        class="form-validation" autocomplete="off">
