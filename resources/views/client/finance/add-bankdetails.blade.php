                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <input type="radio" id="loan_yes" name="active_loan" value="1" >
                                                <label for="loan_yes">Yes</label>
                                            </div>
                                            <div class="col-lg-2">
                                                <input type="radio" id="loan_no" name="active_loan" value="0" >
                                ...
                                <div id="loanDetails" style="display: none;">
                                    <label  class="form-label mt-3 mb-2">If yes fill the following details </label>

                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="organisation_name" class="form-label">State name of organization/institution</label>
                                            <input type="text" class="form-control" name="organisation_name" id="organisation_name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control"  name="organisation_address" id="organisation_address" rows="2" placeholder="Enter address"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="total_debt" id="total_debt">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="remaining_years" id="remaining_years" placeholder="3 years or 8 months">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    <div class="d-grid">
                                        <button type="submit"  class="btn btn-primary" id="addBankDetailsBtn">Save</button>
                                    </div>
                                </div>
							</div>
						</div>
